...
// Voiceflow widget handles the assistant UI globally; no custom button needed here.
// Kept intentionally empty to avoid duplicate floating CTA.
...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="bg-white py-16">
      ...
      {/* Voiceflow widget provides its own launcher; custom AIChatbot disabled. */}
