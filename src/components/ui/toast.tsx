  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-left-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        success: "border-[#14b8a6] bg-[#14b8a6] text-white",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 opacity-70 transition-opacity hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 text-gray-600 hover:text-gray-900 focus:ring-gray-400 [.group[data-variant=success]_&]:text-white/70 [.group[data-variant=success]_&]:hover:text-white [.group[data-variant=success]_&]:focus:ring-white/50 [.group[data-variant=destructive]_&]:text-white/70 [.group[data-variant=destructive]_&]:hover:text-white [.group[data-variant=destructive]_&]:focus:ring-white/50",
      className
    )}
    toast-close=""
    {...props}
