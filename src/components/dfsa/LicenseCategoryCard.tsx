...
export const LicenseCategoryCard: React.FC<LicenseCategoryCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className={`relative ${minimal ? 'p-4 md:p-6' : 'p-6 md:p-8'}`}>
        {minimal ? (
          /* Minimal Card Layout */
          <>
            {/* Compact Header */}
            <div className="flex flex-col items-center text-center mb-4">
              {IconComponent && (
                <div className="p-3 bg-primary/10 rounded-xl group-hover:bg-primary/20 transition-colors mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Category {category.categoryNumber}</p>
              </div>
              {category.badge && (
                <span className="mt-2 px-2 py-1 bg-dfsa-gold text-white text-xs font-semibold rounded-full">
                  {category.badge}
                </span>
              )}
            </div>
