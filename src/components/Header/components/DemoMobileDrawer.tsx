...
interface DemoMobileDrawerProps {
  isCompact?: boolean;
}
const marketplaces = [{
  id: 'non-financial',
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="px-4 py-3">
              ...
              <div className="space-y-1">
                ...
                {/* Make an Enquiry - Emphasized */}
                <button className="w-full flex items-center justify-between px-3 py-2.5 text-left text-teal-700 hover:bg-teal-50 rounded-lg transition-colors text-sm font-bold tracking-tight md:text-[13px] sm:text-xs md:py-2 sm:py-1.5 border-l-3 border-teal-600" onClick={() => handleCTAClick('Make an Enquiry')}>
