      ...
      <div ref={modalRef} className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-end">
            ...
            <button onClick={handlePrimaryAction} className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-md hover:from-blue-700 hover:to-purple-700 transition-colors">
              {config.primaryCTA}
            </button>
          </div>
        </div>
