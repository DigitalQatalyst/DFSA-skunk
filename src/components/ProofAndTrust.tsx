...
const partnerCategories = [
  ...
  },
  {
    ...
    subtitle: "Banks, investment firms, funding institutions, and financiers",
...
const partnerLogos = [
  ...
  { name: "Khalifa Fund", logo: "/logo/KhalifaFund_Logo_Black_RGB.png" },
  ...
  { name: "Hub71", logo: "/logo/hub71.png" },
  { name: "AD SME Hub", logo: "/logo/ad-sme-hub-logo.webp" },
...
const VideoTestimonialCard = ({
  ...
  return (
    <div
      className="relative rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-[300px] cursor-pointer group flex flex-col"
      ...
      >
        ...
        <div className="mt-auto flex-grow flex flex-col justify-end">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Play button */}
            <div
              className={`w-10 h-10 min-w-[40px] min-h-[40px] rounded-full bg-white/30 backdrop-blur-sm flex items-center justify-center transition-all duration-300 ${
...
const PartnerCategoryCard = ({ category, index }) => {
  ...
  return (
    <div
      ref={ref}
      className={`relative overflow-hidden rounded-xl p-6 transition-all duration-500 ease-out transform h-full flex flex-col ${
        ...
        <div className="mb-16">
          ...
          >
            {impactStats.map((stat, index) => (
              <div
                key={index}
                className="bg-blue-50 rounded-lg p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
              >
