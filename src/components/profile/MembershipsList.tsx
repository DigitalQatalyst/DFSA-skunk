    ...
    return <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="p-6">
          <div className="border border-dashed border-gray-300 rounded-lg p-6 text-center">
            ...
            <Link to="/communities">
              <Button variant="secondary" size="sm" className="mt-4 px-4 py-2 text-sm font-medium">
                Explore Communities
              </Button>
            </Link>
          </div>
  ...
  return <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden animate-fade-in">
      ...
      <div className="p-6">
        <div className="space-y-3">
          {memberships.map(membership => <div key={membership.id} className="border border-gray-100 rounded-lg p-4 hover:border-gray-200 hover:shadow-sm transition-all">
              <div className="flex items-start justify-between gap-3">
                ...
                <Link to={`/community/${membership.community.id}`}>
                  <Button variant="secondary" size="sm" className="gap-1 px-3 py-1 text-xs">
                    View
