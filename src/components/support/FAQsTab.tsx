              ...
              <div className="divide-y divide-gray-200">
                {category.questions.map((question) => (
                  <div key={question.id} className="p-3 sm:p-4">
                    ...
                    <div
                      className={`mt-2 text-xs sm:text-sm text-gray-600 overflow-hidden transition-all duration-300 ease-in-out ${
                        expandedQuestions[question.id]
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-md p-3 sm:p-4 mt-4 sm:mt-6">
              ...
              <div className="mt-3">
                <a
                  ...
                  className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 border border-transparent text-xs sm:text-sm font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
                    allowed
                      ? "text-white bg-blue-600 hover:bg-blue-700"
                      : "text-gray-400 bg-gray-300 cursor-not-allowed pointer-events-none"
                  }`}
                  onClick={(e) => {
                    if (!allowed) {
                      e.preventDefault();
