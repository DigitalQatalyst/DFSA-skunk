          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <Input id="invite-email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="member@example.com" disabled={sending} className="pl-9" onKeyDown={e => {
                if (e.key === 'Enter') {
                  handleSendInvite();
                }
              }} />
              </div>
              <Button onClick={handleSendInvite} disabled={sending} className="px-4 py-2 text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white whitespace-nowrap">
