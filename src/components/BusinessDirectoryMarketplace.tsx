...
const BusinessDirectoryMarketplace = () => {
  ...
  useEffect(() => {
    ...
    const allBusinesses: Business[] = [
      ...
      },
      {
        ...
        category: 'Logistics',
        description:
          'Operates and manages ports and related logistics infrastructure in Abu Dhabi and beyond.',
      ...
      },
      {
        ...
        category: 'Finance',
        description:
          'The largest bank in the UAE, offering a full range of financial services to customers across multiple segments.',
      ...
      },
      {
        ...
        category: 'Media',
        description:
          'Media free zone that nurtures media and entertainment businesses in Abu Dhabi.',
      ...
      },
      {
        ...
        category: 'Energy',
        description:
          "One of the world's leading energy producers and a primary catalyst for Abu Dhabi's growth and diversification.",
      ...
      },
      {
        ...
        category: 'Education',
        description:
          'A leading liberal arts and research university bringing together the best of New York and Abu Dhabi.',
      ...
      },
      {
        ...
        category: 'Logistics',
        description:
          "First semi-automated container port in the GCC region, handling all of Abu Dhabi's container traffic.",
        phone: '+971 2 695 2000',
        email: 'info@kizad.ae',
        website: 'kizad.ae',
      ...
      },
      {
        ...
        category: 'Finance',
        description:
          "One of the world's largest sovereign wealth funds, investing funds on behalf of the Government of Abu Dhabi.",
      ...
      },
      {
        ...
        category: 'Tourism',
        description:
          "The world's first Ferrari-branded theme park, featuring record-breaking rides and attractions.",
      ...
      },
      {
        ...
        category: 'Tourism',
        description:
          'Universal museum showcasing art and artifacts from around the world, housed in an architectural masterpiece.',
      ...
      },
      {
        ...
        category: 'Media',
        description:
          'Multi-platform media company delivering content across television, radio, publishing and digital media.',
      ...
      },
      {
        ...
        category: 'Education',
        description:
          "Research-intensive university focused on science, engineering, and medicine to support Abu Dhabi's knowledge economy.",
      ...
      },
      {
        ...
        category: 'Finance',
        description:
          'One of the largest banks in the UAE, providing a comprehensive range of retail and commercial banking services.',
  ...
  return (
    <div
      ref={pageRef}
      className="min-h-screen w-full bg-gray-50 pt-24 pb-20 px-6 md:px-12 opacity-0 -translate-y-4 transition-all duration-1000"
    >
      <div className="container mx-auto">
        ...
        <div className="mb-8">
          <Link
            ...
            className="inline-flex items-center text-primary hover:text-primary-dark transition-colors transform hover:-translate-x-1 duration-200"
          >
        ...
        <div className="bg-white rounded-xl shadow-md mb-12 transition-all duration-300">
          <div className="p-6 flex flex-col md:flex-row md:items-center gap-4">
            ...
            <button
              className={`px-5 py-4 rounded-lg flex items-center justify-center transition-colors ${showFilters ? 'bg-primary text-white' : 'bg-gray-50 text-gray-500 hover:bg-gray-100'}`}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      className="w-full p-3 bg-gray-50 rounded-lg appearance-none border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <div className="flex items-center space-x-1">
              ...
              {Array.from(
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded ${currentPage === number ? 'bg-primary text-white' : 'text-gray-600 hover:bg-gray-100'}`}
                >
                  {number}
                </button>
              ))}
