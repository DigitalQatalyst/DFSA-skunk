...
import { FunnelChart, Funnel, Cell, ResponsiveContainer, Tooltip, PieChart, Pie, LabelList } from 'recharts';
      ...
      <ResponsiveContainer width="100%" height={400}>
        <FunnelChart margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
          ...
          >
            ...
            <LabelList dataKey="value" position="right" style={{ fontSize: 12, fill: '#374151' }} formatter={(v) => v?.toLocaleString?.() || v} />
          </Funnel>
        </FunnelChart>
      </ResponsiveContainer>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <PieChart>
          ...
          >
            ...
            <LabelList dataKey="value" position="outside" style={{ fontSize: 12, fill: '#374151' }} formatter={(v) => v?.toLocaleString?.() || v} />
          </Pie>
          <Tooltip content={renderCustomTooltip} />
        </PieChart>
      </ResponsiveContainer>
