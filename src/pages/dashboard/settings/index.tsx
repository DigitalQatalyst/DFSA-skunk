...
export default function SettingsPage({
  ...
  const renderTabContent = () => {
    switch (activeTabIndex) {
      case 0:
        return (
          <Can I="read" a="user-settings" passThrough>
            {
              ((allowed: boolean) => {
                if (allowed) {
                  return <UserRolesTab />;
                    ...
                    <div className="flex items-center justify-center min-h-[400px] p-6">
                      <div className="text-center max-w-md">
                        ...
                        <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
                          ...
                          <span>
                            Required permission: User Settings Management
                          </span>
                        </div>
                      </div>
                    </div>
      ...
      <div className="min-h-screen flex flex-col bg-gray-50 overflow-x-hidden">
        <div className="flex flex-1 min-w-0">
          <div className="flex-1 min-w-0 px-7">
            ...
            <PageLayout
              title="Settings"
              headerSubtitle="Configure your organization's settings, manage users, and control security preferences."
              breadcrumbs={[
              ...
              <PageSection>
                <SectionContent className="p-0">
                  ...
                  <div className="border-b border-gray-200">
                    ...
                    <div className="px-4 sm:px-6 w-full max-w-screen-2xl mx-auto">
