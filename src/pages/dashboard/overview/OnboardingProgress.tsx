                ...
                <>
                    ...
                    <div className="flex justify-end pr-6 pb-6">
                        <button
                            ...
                            className="px-4 py-2 text-sm font-medium text-white rounded-md bg-gradient-to-r from-primary to-dfsa-gold hover:from-primary/90 hover:to-dfsa-gold/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                        >
                            Continue Setup
                        </button>
                    </div>
