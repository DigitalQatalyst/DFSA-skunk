  ...
  return (
    <div className="space-y-8 max-w-6xl">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Proposed Capital</h3>
        ...
        <div className="mt-4 bg-dfsa-gold-50 border-l-4 border-dfsa-gold-600 p-4">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg className="h-5 w-5 text-dfsa-gold-700" viewBox="0 0 20 20" fill="currentColor">
                <path
                  fillRule="evenodd"
            ...
            <div className="ml-3">
              <h4 className="text-sm font-medium text-dfsa-gold-800">Minimum Capital Requirements</h4>
              <p className="mt-1 text-sm text-dfsa-gold-800">
                The DFSA requires minimum capital levels based on the type of licence and proposed
                activities. Ensure your proposed capital meets or exceeds the applicable minimum:
              </p>
              <ul className="mt-2 text-sm text-dfsa-gold-800 list-disc pl-5 space-y-1">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <p className="text-sm text-gray-600 mb-6">
          Specify all sources of funding for your proposed capital. The total funding amount should
          equal or exceed your proposed capital.
        </p>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <p className="text-xs text-gray-500 mt-4">
          Revenue projections assist in assessing the sustainability of your business model and may
          be used to determine ongoing capital requirements.
        </p>
      </div>
          ...
          render={({ field }) => (
            <textarea
              ...
              className={`
                ...
                resize-none
                ${errors.businessModelDescription ? 'border-red-500' : 'border-gray-300'}
              `}
            />
          )}
        />
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-gray-700">
              Financial information provided in this section will be reviewed as part of the DFSA's
              assessment of your financial resources and solvency. You may be required to provide
              supporting documentation, including audited financial statements, bank references, or
      ...
      <div className="text-xs text-gray-500 pt-4 border-t border-gray-200">
        <p>
          ...
          holders must maintain minimum capital levels throughout the duration of the licence.
        </p>
      </div>
    </div>
  )
