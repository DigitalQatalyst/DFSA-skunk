...
export const ShareholdingStep: React.FC = () => {
  return (
    <div className="space-y-6 max-w-6xl">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-gray-900 tracking-tight">Shareholding Structure</h2>
      ...
      {/* Shareholder Information Group */}
      <FormFieldGroup
        title="Shareholder Information"
        groupId="shareholder-information"
        fieldNames={['shareholders']}
        isRequired={true}
        helpText="Provide details of all shareholders and their ownership percentages. Total ownership must equal exactly 100%. All shareholders must be listed, regardless of ownership percentage. (Ref: DFSA Rulebook GEN Module Rule 2.2.2)"
