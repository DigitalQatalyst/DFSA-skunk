          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden animate-fade-in">
              <Tabs defaultValue="all" className="w-full">
                <div className="border-b border-gray-200 px-2 md:px-6 lg:px-8">
                ...
                <TabsContent value="all" className="p-6 m-0">
                  {notifications.length === 0 ? (
                    <div className="border border-dashed border-gray-300 rounded-lg p-6 text-center h-[calc(100vh-200px)]">
