...
import { REGISTRATION_CATEGORIES } from '../../constants/dfsa-pathways';
...
/**
 * Registration Page
 * Category selection for DFSA Registration
 * Displays 2 selectable category cards (RA, DNFBP)
 */
        ...
        <FadeInUpOnScroll delay={0}>
          ...
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-xs uppercase text-gray-500">
              ...
              <li className="text-gray-700 font-semibold">REGISTRATION</li>
            </ol>
          </nav>
          ...
          <div className="mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-4xl">
              Select the registration category applicable to your proposed
              activities.
            </p>
          </div>
        </FadeInUpOnScroll>
